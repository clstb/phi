...
var file_proto_transaction_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x22, 0x33, 0x0a, 0x0c, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x92, 0x01, 0x0a, 0x11,
	...
	0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x02, 0x74, 0x6f, 0x12, 0x21, 0x0a,
...
var file_proto_transaction_proto_goTypes = []interface{}{
	...
	(*Posting)(nil),               // 4: pb.Posting
}
var file_proto_transaction_proto_depIdxs = []int32{
	3, // 0: pb.Transaction.date:type_name -> google.protobuf.Timestamp
	4, // 1: pb.Transaction.postings:type_name -> pb.Posting
	0, // 2: pb.Transactions.data:type_name -> pb.Transaction
	3, // 3: pb.TransactionsQuery.from:type_name -> google.protobuf.Timestamp
	3, // 4: pb.TransactionsQuery.to:type_name -> google.protobuf.Timestamp
